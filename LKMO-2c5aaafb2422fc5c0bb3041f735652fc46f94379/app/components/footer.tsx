            ...
            <div className="grid md:grid-cols-3 gap-7">
                ...
                <div>
                    ...
                    <form action="" className="mt-5">
                        <div className="mb-5">
                            <input type="text" name="email" placeholder="LKMO@gmail.com" className="w-full p-3 rounded-sm bg-white" />
                        </div>
                            <button className="bg-orange-400 p-3 font-bold text-white w-full text-center rounded-sm hover:bg-orange-500">Send Message</button>
                    </form>
                </div>
            </div>
        </div>
